...
p_log <- ggplot(spy_df, aes(x = date)) +
  geom_line(aes(y = log_price, linetype = "Log price"), colour = "black", linewidth = 0.5) +
  geom_line(aes(y = trend_global_log, linetype = "Global trend"), colour = "blue", linewidth = 0.8) +
  geom_line(aes(y = trend_local_log, linetype = "Local trend"), colour = "red", linewidth = 0.8) +
  scale_linetype_manual(values = c("Log price" = "solid",
                                   "Global trend" = "dashed",
                                   "Local trend" = "dotdash"),
                        name = NULL) +
...
p_level <- ggplot(spy_df, aes(x = date)) +
  geom_line(aes(y = price, linetype = "Price"), colour = "black", linewidth = 0.5) +
  geom_line(aes(y = trend_global, linetype = "Global trend"), colour = "blue", linewidth = 0.8) +
  geom_line(aes(y = trend_local, linetype = "Local trend"), colour = "red", linewidth = 0.8,
            na.rm = TRUE) +
  scale_linetype_manual(values = c("Price" = "solid",
                                   "Global trend" = "dashed",
                                   "Local trend" = "dotdash"),
                        name = NULL) +
